...
// Liger
#define COCOAPODS_POD_AVAILABLE_Liger
#define COCOAPODS_VERSION_MAJOR_Liger 0
#define COCOAPODS_VERSION_MINOR_Liger 0
#define COCOAPODS_VERSION_PATCH_Liger 8
